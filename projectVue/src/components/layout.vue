  ...
  <div>
    <div class="app-header">
      <div class="app-head-inner">
        <router-link class="head-logo" tag="div"  :to="{ name: 'index' }">
        ...
        <div class="head-nav">
          <ul class="nav-list">
            ...
            <li class="nav-pile" v-if="username !== ''">退出</li>
    ...
    <my-dialog :isShow="isShowLogDialog" @on-close="closeDialog('isShowLogDialog')">
      <p>
        <log-form @has-log="onScussLog"></log-form>
      </p>
    </my-dialog>
    <!--注册-->
...
import logForm from './layoutForm.vue'
