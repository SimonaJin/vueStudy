<template>
  <div class="sales-board">
    ...
    <pay-dialog :is-show="isShowDialog" @on-close="hideShowDialog">
      ...
      <bank-chooser @on-change="onChangeBanks(bankId)">
    ...
    <pay-dialog :is-show="isShowErrDialog" @on-close="hideErrDialog">
      支付失败！
    </pay-dialog>
