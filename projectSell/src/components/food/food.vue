      ...
      <div v-show="showFlag" class="food" ref="food">
        <div class="food-content">
          ...
          <div class="ratings">
            ...
            <ratings @select="selectRating" @toggle="toggleContent" :selectType="selectType"
                     :onlyContent="onlyContent" :desc="desc"
                     :ratings="food.ratings">></ratings>
...
<script>
  ...
  import ratings from 'components/ratingselect/ratingselect.vue'
